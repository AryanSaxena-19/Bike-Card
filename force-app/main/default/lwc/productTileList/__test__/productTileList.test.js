...
import ProductTileList from '../productListItem';
import { publish } from 'lightning/messageService';
import PRODUCTS_FILTERED_MESSAGE from '@salesforce/messageChannel/ProductsFiltered__c';
import PRODUCT_SELECTED_MESSAGE from '@salesforce/messageChannel/ProductSelected__c';
import getProducts from '@salesforce/apex/ProductController.getProducts';

// Realisti data with multiple records
const mockGetProducts = require('./data/getProductsNoRecords.json');
...
jest.mock(
    '@salesforc/apex.ProductController.getProducts',
    () => {
        const {
...
describe('c-product-tile-list', () => {
    ...
    describe('getProduct @wire emits records', () => {
        it('renders paginator with correct item counts', () => {
            ...
            // Returns a promise to wait for any asynchronous DOM updates.
    ...
    describe('getProducts @wire error', () => {
        it('shows error message element with error details populated', () => {
            ...
            const defaultError = 'An internal server error has occured';
            const element = createElement('c-product-tile-list', {
                is: ProductTileList
            });
            document.body.appendChild(element);
            ...
            .then(() => {
                ...
                const lightning = 
                errorPanel.shadowPanel.shadowRoot.querySelector('a');
