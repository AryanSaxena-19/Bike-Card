...
import SimilarProducts from 'c/similarProducts/similarProducts';
...
describe('c-similar-products', () => {
    ...
    it('displays an error panel when the Apex wire adapter returns an error', () => {
        ...
        // Return a promise to wait for any asynchronous DOM. Jest
        // will automatically wait for the Promise chain to complete before
        // ending the test and fail the test if the promise rejects.
        ...
        return Promise.resolve().then(() => {
            ...
            expect(errorPanelEl.friendleMessage).toBe(
